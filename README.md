# Abu and Stella's Shell

### Description

Abu and Stella's Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh). Additional functions are also included. This program was written entirely in C as a milestone project for Holberton School.
...
All code written by [Stella Nwae](https://github.com/Stellanwae) and [Abdulkarim Mapesa](https://github.com/xAbu042).
